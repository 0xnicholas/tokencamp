...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/v1/images/generations", post(routes::media::images_generations))
        .route("/v1/audio/transcriptions", post(routes::media::audio_transcriptions))
        .route("/v1/audio/speech", post(routes::media::audio_speech))
